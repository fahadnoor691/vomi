...
def minimize_window():
    return desktop_agent.minimize_windows()

def close_windows():
    return desktop_agent.close_windows()

def restore_windows():
    return desktop_agent.restore_windows()

def lock_computer():
    return desktop_agent.lock_computer()

def get_system_info():
    return desktop_agent.get_system_info()

def get_running_apps():
    return desktop_agent.get_running_apps()

def get_system_battery():
    return desktop_agent.get_system_battery()

def get_ip_address():
    return desktop_agent.get_ip_address()
...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Search the web for current information on any topic, question, or subject.",
            "parameters": {
                "type": "object",
